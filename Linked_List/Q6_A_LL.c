...
int moveMaxToFront(ListNode **ptrHead)
{
	...
	{
		pre->next = highest->next;
	}
	
	//Put the highest number at the front 
	
	*ptrHead = highest; // ll's head = highest
	highest->next = head; // Assign highest.next to original head 
